...
.mb-board .mb-dash-title{font-size: 21px;margin: 0;line-height: 1.2em;display: block;font-weight: 600;float:left;padding:2px 30px 0 0;}
.mb-board .mb-dash-panel-title{font-size: 16px;padding: 10px 0 0;margin: 0;line-height: 2.1em;display: block;font-weight: 600;}
.mb-board .mb-dash-box-title{font-size: 14px;padding: 8px 12px;margin: 0;line-height: 1.4em;border-bottom: 1px solid #eee;display: block;font-weight: 600;}
...
.gallery-list .gallery-list-body .gallery-hover-box{
	padding:10px 7px 10px 7px  !important; font-weight:600 !important; font-size:12px !important; position:absolute; bottom:0px; width:100%; background:rgba(0,0,0,0.6);	line-height:22px;opacity:0;	min-height:66px;
...
.gallery-list .gallery-list-body .gallery-hover-box .hover-btn{color:#FFF;border:1px solid #FFF;padding:2px;text-align:center;margin-top:5px;}
.gallery-list .gallery-list-body .gallery-hover-box .hover-btn:hover{color:#fff !important;background-color:rgba(255,255,255,0.2);}

.gallery-list .gallery-list-body .gallery-hover-box .hover-btn3{background-color:rgba(93,151,205,0.9);}
.gallery-list .gallery-list-body .gallery-hover-box .hover-btn.hover-btn3:hover{background-color:rgba(93,151,205,1);}
.gallery-list .gallery-list-body .gallery-hover-box .hover-btn4{background-color:rgba(224,48,48,0.9);}
	...
	if(!empty($product_items)){
		foreach($product_items as $product) {
			...
			if(!empty($product['is_order'])){
				if(is_dir(WP_CONTENT_DIR.'/'.$product['check_dir'])){		//설치가 되어있는지 체크
			...
			<div class="mc-gallery-title text-center bold" style="font-size:13px;font-weight:600 !important;padding:2px 2px 2px;">
