...
<script type="text/javascript" src="<?php echo MBW_PLUGIN_URL;?>plugins/editors/smart/js/lib/jindo2.all.js?ver=1.4.9" charset="utf-8"></script>
<script type="text/javascript" src="<?php echo MBW_PLUGIN_URL;?>plugins/editors/smart/js/lib/jindo_component.js?ver=1.4.9" charset="utf-8"></script>
<script type="text/javascript" src="<?php echo MBW_PLUGIN_URL;?>plugins/editors/smart/js/service/SE2M_Configuration.js?ver=1.4.9" charset="utf-8"></script>	<!-- 설정 파일 -->
<script type="text/javascript" src="<?php echo MBW_PLUGIN_URL;?>plugins/editors/smart/js/service/SE2BasicCreator.js?ver=1.4.9" charset="utf-8"></script>
<script type="text/javascript" src="<?php echo MBW_PLUGIN_URL;?>plugins/editors/smart/js/smarteditor2.min.js?ver=1.4.9" charset="utf-8"></script>
<!-- 사진첨부기능 edit --> 
<script type="text/javascript" src="<?php echo MBW_PLUGIN_URL;?>plugins/editors/smart/sample/js/plugin/hp_SE2M_AttachQuickPhoto.js?ver=1.4.9" charset="utf-8"></script>
