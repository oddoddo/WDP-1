...
function createSEditor2(elIRField, htParams, elSeAppContainer){
	...
	var htDimension = {
		nMinHeight:255,			//mb edit
		nMinWidth:parseInt(elIRField.style.minWidth, 10)||240,		//mb edit
		nHeight:elIRField.style.height||elIRField.offsetHeight,
		nWidth:elIRField.style.width||elIRField.offsetWidth
	};

	if(htParams.bUsePhotoUpload === 'undefined') bUsePhotoUpload : false;		//mb edit	
	var htConversionMode = {		
		bUsePhotoUpload : htParams.bUsePhotoUpload,		//mb edit
