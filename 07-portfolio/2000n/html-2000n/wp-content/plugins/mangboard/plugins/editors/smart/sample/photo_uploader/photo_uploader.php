...
<script type="text/javascript">var mb_editor_url="<?php echo MBW_PLUGIN_URL;?>plugins/editors/smart/";var mb_admin_url="<?php echo mbw_check_url(admin_url());?>";</script>
...
<script type="text/javascript" src="<?php echo MBW_PLUGIN_URL."plugins/editors/smart/sample/photo_uploader/";?>jindo.min.js?ver=1.4.8" charset="utf-8"></script>
<script type="text/javascript" src="<?php echo MBW_PLUGIN_URL."plugins/editors/smart/sample/photo_uploader/";?>jindo.fileuploader.js?ver=1.4.8" charset="utf-8"></script>
<script type="text/javascript" src="<?php echo MBW_PLUGIN_URL."plugins/editors/smart/sample/photo_uploader/";?>attach_photo.js?ver=1.4.8" charset="utf-8"></script>
