	...
	function mbw_get_admin_template($mode, $data){
		...
		if($item_type=='admin_board_name'){
			...
			$template_start	.= '<div class="mb-upload-media-wrap">';
				...
				if(!empty($option_value)) $option_style		= "";
				$template_start	.= '<div style="max-width:300px;max-width:150px;margin-top:3px;'.$option_style.'"><img src="'.$option_value.'" id="'.$option_id.'_image"></div>';
			$template_start	.= '</div>';
