...
if(!function_exists('mbw_get_resize_responsive')){
	function mbw_get_resize_responsive($device_type){		
		...
		if(mbw_get_trace("mbw_get_resize_responsive")==""){
			...
			$responsive_script		= $responsive_script.'var nWidth		= window.innerWidth;';	
			...
			$responsive_script		= $responsive_script.'if(typeof jQuery != "undefined"){ jQuery(window).resize(resizeResponsive);resizeResponsive();};';
