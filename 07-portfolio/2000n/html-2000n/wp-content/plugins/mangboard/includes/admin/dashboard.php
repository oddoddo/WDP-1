...
function mbw_dsahboard_language(){
	...
	moveURL("<?php echo admin_url('admin.php?page=mbw_dashboard&lang=');?>"+lang);
}
</script>
<style type="text/css">
...
.mb-dash .welcome-panel td{line-height:1.6em !important }
...
.mb-dash .button{min-height:30px !important;line-height:2em}
.mb-dash select,.mb-board input{min-height:30px;line-height:normal;font-size:13px;}
</style>
	...
	<div class="welcome-panel-content">
		...
		<div class="welcome-panel-column-container">
			...
			<div class="welcome-panel-column welcome-panel-last">
				<div class="mb-dash-panel-title"><?php echo __MW('W_REFERER_LATESET'); ?><span style="font-size:12px;color:#999;line-height:1.2em;"> (<?php echo __MW('W_ONE_WEEK'); ?>)</span></div>				
				<div style="text-align:center;width:90%;">
					<?php
